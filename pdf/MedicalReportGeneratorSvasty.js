...
const generateMedicalReportSvastyHTML = (dataToSave) => {
  ...
  return `
        <html>
              ...
              esIphoneWeb ? "-30px" : "5px"
                        ...
                        .titleBold { font-size: 30px; font-weight: bold; text-align: right; color: #000000; }
                        .form-container { 
...
export default generateMedicalReportSvastyHTML;